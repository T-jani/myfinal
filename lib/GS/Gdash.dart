...
// import 'package:myapp/CCD/Cchatpage.dart';
import 'package:myapp/GS/Gchatpage.dart';
...
class Gdashmain extends StatelessWidget {
  const Gdashmain({Key? key});
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => Gchatpage()),
          );
        },
